...
def generate_spheres():	
	...
	for point in point_records:	
		...
		if point_to_a != 0:			
			...
			"""
			angle_x = str(angle_between([1, 0, 0], [normal[0], 0, 0]))
			angle_y = str(angle_between([0, 1, 0], [0, normal[1], 0]))
			angle_z = str(angle_between([0, 0, 1], [0, 0, normal[2]]))
			"""
			# Point colors
	...
	max_points = int(number_points / 10)
